/* ToyKeeper's Keychron V1 QMK keymap
...
#define MY_LAYOUT_base(                             K01, K02, \
    ...
    KC_GRV , KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , K01    , K02    , KC_BSLS, KC_PGUP, \
...
[L_NUMPAD] = MY_LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    // gap
    _______, _______, _______, _______, _______, _______, _______, KC_SLSH, TK_ASTR, TK_LPAR, TK_RPAR, _______, _______, _______, _______,
    ...
    _______, _______, _______, _______, _______, _______, KC_0   , KC_1   , KC_2   , KC_3   , KC_SLSH,      _______,     _______,
    _______, _______, _______,                   _______,                            _______, _______, _______, _______, _______, _______
    ),
...
[L_FN1] = MY_LAYOUT(
 TG(L_FLCK), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    // gap
    _______, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 , TK_BSTG, KC_WH_U,
    KC_MPLY, KC_MNXT, KC_MPRV, TK_ANY , _______, _______, _______, KC_WH_U, KC_MS_U, KC_WH_D, _______, _______, _______, KC_DEL , KC_WH_D,
    _______, DM_REC1, DM_REC2, _______, _______, _______, KC_WH_L, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_R, _______,      KC_BTN3,     KC_BTN2,
    KC_BTN3, DM_PLY1, DM_PLY2, _______, _______, _______, TK_WARP, KC_BTN1, KC_BTN3, KC_BTN2, _______,      KC_BTN1,     KC_MS_U,
