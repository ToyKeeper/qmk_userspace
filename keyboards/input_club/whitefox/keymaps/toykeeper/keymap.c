...
#define MY_LAYOUT_base(                             K01, K02, \
    ...
    TK_MOON, TK_LGUI, TK_LALT,                   KC_SPC ,                            TK_RCTL, TK_RGUI,          KC_LEFT, KC_DOWN,  KC_RGHT  \
    )
...
// Number Pad(s)
[L_NUMPAD] = MY_LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, KC_NUM , KC_PAST, TK_LPAR, TK_RPAR, _______, _______, _______, _______, _______,
...
[L_FN2] = MY_LAYOUT(
    ...
    TK_DF_0, TK_DF_1, TK_DF_2,                   _______,                            KC_APP , _______,          KC_HOME, KC_PGDN, KC_END
    )
